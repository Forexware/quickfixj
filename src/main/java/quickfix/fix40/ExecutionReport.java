...
public class ExecutionReport extends Message {
    ...
    public ExecutionReport(quickfix.field.OrderID orderID,
        ...
        quickfix.field.OrdStatus ordStatus, quickfix.field.Symbol symbol,
        quickfix.field.Side side, quickfix.field.OrderQty orderQty,
        quickfix.field.LastShares lastShares, quickfix.field.LastPx lastPx,
