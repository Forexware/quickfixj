...
public class NewOrderList extends Message {
    ...
    public NewOrderList(quickfix.field.ListID listID,
        quickfix.field.ListSeqNo listSeqNo,
        quickfix.field.ListNoOrds listNoOrds, quickfix.field.ClOrdID clOrdID,
        quickfix.field.HandlInst handlInst, quickfix.field.Symbol symbol,
