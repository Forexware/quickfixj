...
public class Allocation extends Message {
    ...
    public Allocation(quickfix.field.AllocID allocID,
        quickfix.field.AllocTransType allocTransType, quickfix.field.Side side,
        quickfix.field.Symbol symbol, quickfix.field.Shares shares,
    ...
    public static class NoOrders extends Group {
        ...
        public NoOrders() {
            super(73, 11, new int[] { 11, 37, 66, 105, 0 });
        }
    ...
    public static class NoExecs extends Group {
        ...
        public NoExecs() {
            super(124, 17, new int[] { 17, 32, 31, 30, 0 });
        }
        ...
        public quickfix.field.LastShares getLastShares()
            throws FieldNotFound {
    ...
    public static class NoAllocs extends Group {
        ...
        public NoAllocs() {
            super(78, 79, new int[] { 79, 80, 81, 76, 109, 12, 13, 85, 0 });
        }
        ...
        public static class NoDlvyInst extends Group {
            ...
            public quickfix.field.BrokerOfCredit get(
                quickfix.field.BrokerOfCredit value) throws FieldNotFound {
                getField(value);

                return value;
            }

            public quickfix.field.BrokerOfCredit getBrokerOfCredit()
                throws FieldNotFound {
            ...
            public quickfix.field.DlvyInst get(quickfix.field.DlvyInst value)
                throws FieldNotFound {
                getField(value);
            ...
            public quickfix.field.DlvyInst getDlvyInst()
                throws FieldNotFound {
                quickfix.field.DlvyInst value = new quickfix.field.DlvyInst();
                getField(value);
