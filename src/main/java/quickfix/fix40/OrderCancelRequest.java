...
public class OrderCancelRequest extends Message {
    ...
    public OrderCancelRequest(quickfix.field.OrigClOrdID origClOrdID,
        quickfix.field.ClOrdID clOrdID, quickfix.field.CxlType cxlType,
        quickfix.field.Symbol symbol, quickfix.field.Side side,
        quickfix.field.OrderQty orderQty) {
        this();
    ...
    public quickfix.field.CxlType get(quickfix.field.CxlType value)
        throws FieldNotFound {
        getField(value);
    ...
    public quickfix.field.CxlType getCxlType() throws FieldNotFound {
        quickfix.field.CxlType value = new quickfix.field.CxlType();
        getField(value);
