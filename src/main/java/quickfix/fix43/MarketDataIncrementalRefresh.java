...
public class MarketDataIncrementalRefresh extends Message {
    ...
    public static class NoMDEntries extends Group {
        ...
        public NoMDEntries() {
            super(268, 279,
                new int[] {
                    ...
                    200, 541, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471,
                    472, 240, 202, 206, 231, 223, 207, 106, 348, 349, 107, 350,
                    351, 291, 292, 270, 15, 271, 272, 273, 274, 275, 336, 625,
                    276, 277, 282, 283, 284, 286, 59, 432, 126, 110, 18, 287, 37,
                    299, 288, 289, 346, 290, 546, 387, 449, 450, 451, 58, 354,
                    355, 0
                });
        }
        ...
        public quickfix.field.OpenCloseSettleFlag get(
            quickfix.field.OpenCloseSettleFlag value) throws FieldNotFound {
            getField(value);

            return value;
        }

        public quickfix.field.OpenCloseSettleFlag getOpenCloseSettleFlag()
            throws FieldNotFound {
        ...
        public quickfix.field.TotalVolumeTradedDate get(
            quickfix.field.TotalVolumeTradedDate value)
            throws FieldNotFound {
            getField(value);
        ...
        public quickfix.field.TotalVolumeTradedDate getTotalVolumeTradedDate()
            throws FieldNotFound {
        ...
        public quickfix.field.TotalVolumeTradedTime get(
            quickfix.field.TotalVolumeTradedTime value)
            throws FieldNotFound {
            getField(value);
        ...
        public quickfix.field.TotalVolumeTradedTime getTotalVolumeTradedTime()
            throws FieldNotFound {
