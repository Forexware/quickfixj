...
public class OrderCancelReject extends Message {
    ...
    public OrderCancelReject(quickfix.field.OrderID orderID,
        ...
        quickfix.field.CxlRejResponseTo cxlRejResponseTo) {
        this();
        setField(orderID);
        setField(clOrdID);
    ...
    public quickfix.field.CxlRejResponseTo get(
        quickfix.field.CxlRejResponseTo value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.CxlRejResponseTo getCxlRejResponseTo()
        throws FieldNotFound {
