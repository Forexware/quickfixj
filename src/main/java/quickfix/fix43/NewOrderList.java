...
public class NewOrderList extends Message {
    ...
    public static class NoOrders extends Group {
        ...
        public NoOrders() {
            super(73, 11,
                new int[] {
                    11, 526, 67, 583, 160, 453, 229, 1, 581, 589, 590, 591, 78,
                    63, 64, 544, 635, 21, 18, 110, 111, 100, 386, 81, 55, 65, 48,
                    22, 454, 460, 461, 167, 200, 541, 224, 225, 239, 226, 227,
                    228, 255, 543, 470, 471, 472, 240, 202, 206, 231, 223, 207,
                    106, 348, 349, 107, 350, 351, 140, 54, 401, 114, 60, 232,
                    465, 38, 152, 516, 468, 469, 40, 423, 44, 99, 218, 220, 221,
                    222, 235, 236, 15, 376, 377, 23, 117, 59, 168, 432, 126, 427,
                    12, 13, 479, 497, 528, 529, 582, 47, 121, 120, 58, 354, 355,
                    193, 192, 640, 77, 203, 210, 211, 388, 389, 494, 158, 159,
                    118, 0
                });
        }
        ...
        public quickfix.fix43.component.YieldData get(
            quickfix.fix43.component.YieldData component)
            throws FieldNotFound {
            getComponent(component);
