...
public class SecurityTypes extends Message {
    ...
    public quickfix.field.TotalNumSecurityTypes get(
        quickfix.field.TotalNumSecurityTypes value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.TotalNumSecurityTypes getTotalNumSecurityTypes()
        throws FieldNotFound {
    ...
    public static class NoSecurityTypes extends Group {
        ...
        public NoSecurityTypes() {
            super(558, 167, new int[] { 167, 460, 461, 0 });
        }
