...
public class Message extends quickfix.Message {
    ...
    public static class Header extends quickfix.Message.Header {
        ...
        public quickfix.field.OnBehalfOfSendingTime get(
            quickfix.field.OnBehalfOfSendingTime value)
            throws FieldNotFound {
            getField(value);
        ...
        public quickfix.field.OnBehalfOfSendingTime getOnBehalfOfSendingTime()
            throws FieldNotFound {
            quickfix.field.OnBehalfOfSendingTime value = new quickfix.field.OnBehalfOfSendingTime();
            getField(value);
        ...
        public static class NoHops extends Group {
            ...
            public quickfix.field.HopRefID getHopRefID()
                throws FieldNotFound {
