...
public class BidRequest extends Message {
    ...
    public BidRequest(quickfix.field.ClientBidID clientBidID,
        ...
        quickfix.field.TotalNumSecurities totalNumSecurities,
        quickfix.field.BidType bidType, quickfix.field.TradeType tradeType,
    ...
    public static class NoBidComponents extends Group {
        ...
        public NoBidComponents() {
            super(420, 66, new int[] { 66, 54, 336, 625, 430, 63, 64, 1, 0 });
        }
