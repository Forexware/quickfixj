...
public class Allocation extends Message {
    ...
    public Allocation(quickfix.field.AllocID allocID,
    ...
    public quickfix.field.AvgPrxPrecision get(
        quickfix.field.AvgPrxPrecision value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.AvgPrxPrecision getAvgPrxPrecision()
        throws FieldNotFound {
    ...
    public static class NoOrders extends Group {
        ...
        public NoOrders() {
            super(73, 11, new int[] { 11, 37, 198, 526, 66, 0 });
        }
    ...
    public static class NoExecs extends Group {
        ...
        public NoExecs() {
            super(124, 32, new int[] { 32, 17, 527, 31, 29, 0 });
        }
    ...
    public static class NoAllocs extends Group {
        ...
        public NoAllocs() {
            super(78, 79,
                new int[] {
                    79, 366, 80, 467, 81, 539, 208, 209, 161, 360, 361, 12, 13,
                    479, 497, 153, 154, 119, 120, 155, 156, 159, 160, 136, 0
                });
        }
