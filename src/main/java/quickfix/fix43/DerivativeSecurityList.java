...
public class DerivativeSecurityList extends Message {
    ...
    public quickfix.field.TotalNumSecurities get(
        quickfix.field.TotalNumSecurities value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.TotalNumSecurities getTotalNumSecurities()
        throws FieldNotFound {
    ...
    public static class NoRelatedSym extends Group {
        ...
        public NoRelatedSym() {
            super(146, 55,
                new int[] {
                    ...
                    223, 207, 106, 348, 349, 107, 350, 351, 15, 555, 336, 625,
                    58, 354, 355, 0
                });
        }
        ...
        public static class NoLegs extends Group {
            ...
            public NoLegs() {
                super(555, 600,
                    new int[] {
                        600, 601, 602, 603, 604, 607, 608, 609, 610, 611, 248,
                        249, 250, 251, 252, 253, 257, 599, 596, 597, 598, 254,
