...
public class OrderRestrictions extends StringField {
    ...
    public static final char ACTING_AS_MARKET_MAKER_OR_SPECIALIST_IN_THE_SECURITY =
        '5';
    public static final char ACTING_AS_MARKET_MAKER_OR_SPECIALIST_IN_THE_UNDERLYING_SECURITY_OF_A_DERIVATIVE_SECURITY =
        '6';
