...
public class SecurityList extends Message {
    ...
    public SecurityList(quickfix.field.SecurityReqID securityReqID,
        quickfix.field.SecurityResponseID securityResponseID,
        quickfix.field.SecurityRequestResult securityRequestResult) {
        this();
        ...
        public NoRelatedSym() {
            super(146, 55,
                new int[] {
                    ...
                    875, 876, 864, 873, 874, 668, 869, 870, 913, 914, 915, 918,
            ...
            public NoLegs() {
                super(555, 600,
                    new int[] {
                        ...
                        621, 622, 623, 624, 556, 740, 739, 955, 956, 690, 587,
                        683, 676, 677, 678, 679, 680, 0
                    });
            }
