...
public class TradingSessionStatus extends Message {
    ...
    public TradingSessionStatus(
        quickfix.field.TradingSessionID tradingSessionID,
        quickfix.field.TradSesStatus tradSesStatus) {
        this();
    ...
    public quickfix.field.TradSesStatusRejReason get(
        quickfix.field.TradSesStatusRejReason value) throws FieldNotFound {
        getField(value);
