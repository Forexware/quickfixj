...
public class PositionMaintenanceReport extends Message {
    ...
    public PositionMaintenanceReport(
        ...
        quickfix.field.OrigPosReqRefID origPosReqRefID,
        quickfix.field.PosMaintStatus posMaintStatus,
        quickfix.field.ClearingBusinessDate clearingBusinessDate,
        quickfix.field.Account account, quickfix.field.AccountType accountType,
    ...
    public quickfix.fix44.component.PositionQty get(
        quickfix.fix44.component.PositionQty component)
        throws FieldNotFound {
        getComponent(component);
    ...
    public quickfix.fix44.component.PositionQty getPositionQty()
        throws FieldNotFound {
        quickfix.fix44.component.PositionQty component = new quickfix.fix44.component.PositionQty();
        getComponent(component);
    ...
    public static class NoPositions extends Group {
        ...
        public NoPositions() {
            super(702, 703, new int[] { 703, 704, 705, 706, 539, 0 });
        }
