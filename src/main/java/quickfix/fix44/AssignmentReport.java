...
public class AssignmentReport extends Message {
    ...
    public AssignmentReport(quickfix.field.AsgnRptID asgnRptID,
        quickfix.field.AccountType accountType,
        quickfix.field.SettlPrice settlPrice,
        quickfix.field.SettlPriceType settlPriceType,
        quickfix.field.UnderlyingSettlPrice underlyingSettlPrice,
        quickfix.field.AssignmentMethod assignmentMethod,
        quickfix.field.OpenInterest openInterest,
        quickfix.field.ExerciseMethod exerciseMethod,
        quickfix.field.SettlSessID settlSessID,
        quickfix.field.SettlSessSubID settlSessSubID,
