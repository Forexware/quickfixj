...
public class CollateralAssignment extends Message {
    ...
    public CollateralAssignment(quickfix.field.CollAsgnID collAsgnID,
        quickfix.field.CollAsgnReason collAsgnReason,
        quickfix.field.CollAsgnTransType collAsgnTransType,
    ...
    public quickfix.field.CollAsgnRefID get(quickfix.field.CollAsgnRefID value)
        throws FieldNotFound {
        getField(value);
    ...
    public quickfix.field.CollAsgnRefID getCollAsgnRefID()
        throws FieldNotFound {
        quickfix.field.CollAsgnRefID value = new quickfix.field.CollAsgnRefID();
        getField(value);
