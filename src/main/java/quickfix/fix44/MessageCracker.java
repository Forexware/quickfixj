 ...
 */
  ...
  */
    ...
    throws UnsupportedMessageType, FieldNotFound, IncorrectTagValue
  {
    ...
    if( msgTypeValue.equals(MultilegOrderCancelReplaceRequest.MSGTYPE) )
    ...
    if( msgTypeValue.equals(ConfirmationAck.MSGTYPE) )
    ...
    if( msgTypeValue.equals(NetworkStatusRequest.MSGTYPE) )
      onMessage( (NetworkStatusRequest)message, sessionID );
    else
    if( msgTypeValue.equals(NetworkStatusResponse.MSGTYPE) )
