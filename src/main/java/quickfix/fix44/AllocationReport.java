...
public class AllocationReport extends Message {
    ...
    public AllocationReport(quickfix.field.AllocReportID allocReportID,
        ...
        quickfix.field.AllocNoOrdersType allocNoOrdersType,
        quickfix.field.Side side, quickfix.field.Quantity quantity,
        quickfix.field.AvgPx avgPx, quickfix.field.TradeDate tradeDate) {
        this();
    ...
    public static class NoExecs extends Group {
        ...
        public NoExecs() {
            super(124, 32, new int[] { 32, 17, 527, 31, 669, 29, 0 });
        }
    ...
    public static class NoAllocs extends Group {
        ...
        public NoAllocs() {
            super(78, 79,
                new int[] {
                    ...
                    742, 741, 136, 576, 635, 780, 172, 169, 170, 171, 85, 0
                });
        }
        ...
        public void set(
            quickfix.fix44.component.SettlInstructionsData component) {
            setComponent(component);
        }

        public quickfix.fix44.component.SettlInstructionsData get(
            quickfix.fix44.component.SettlInstructionsData component)
            throws FieldNotFound {
            getComponent(component);
        ...
        public quickfix.fix44.component.SettlInstructionsData getSettlInstructionsData()
            throws FieldNotFound {
            quickfix.fix44.component.SettlInstructionsData component = new quickfix.fix44.component.SettlInstructionsData();
            getComponent(component);
