...
public class LegBenchmarkCurveData extends quickfix.MessageComponent {
    ...
    public quickfix.field.LegBenchmarkCurveName get(
        quickfix.field.LegBenchmarkCurveName value) throws FieldNotFound {
        getField(value);
    ...
    public quickfix.field.LegBenchmarkCurvePoint get(
        quickfix.field.LegBenchmarkCurvePoint value) throws FieldNotFound {
        getField(value);
    ...
    public quickfix.field.LegBenchmarkPriceType get(
        quickfix.field.LegBenchmarkPriceType value) throws FieldNotFound {
        getField(value);
