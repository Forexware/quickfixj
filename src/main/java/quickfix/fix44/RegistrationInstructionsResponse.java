...
public class RegistrationInstructionsResponse extends Message {
    ...
    public RegistrationInstructionsResponse(quickfix.field.RegistID registID,
        quickfix.field.RegistTransType registTransType,
        quickfix.field.RegistRefID registRefID,
        quickfix.field.RegistStatus registStatus) {
        this();
        setField(registID);
    ...
    public quickfix.field.RegistRejReasonCode get(
        quickfix.field.RegistRejReasonCode value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.RegistRejReasonCode getRegistRejReasonCode()
        throws FieldNotFound {
    ...
    public quickfix.field.RegistRejReasonText get(
        quickfix.field.RegistRejReasonText value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.RegistRejReasonText getRegistRejReasonText()
        throws FieldNotFound {
