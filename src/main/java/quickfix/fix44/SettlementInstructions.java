...
public class SettlementInstructions extends Message {
    ...
    public SettlementInstructions(
        quickfix.field.SettlInstMsgID settlInstMsgID,
    ...
    public quickfix.field.SettlInstMsgID get(
        quickfix.field.SettlInstMsgID value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.SettlInstMsgID getSettlInstMsgID()
    ...
    public quickfix.field.SettlInstReqRejCode get(
        quickfix.field.SettlInstReqRejCode value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.SettlInstReqRejCode getSettlInstReqRejCode()
        throws FieldNotFound {
    ...
    public quickfix.field.NoSettlInst getNoSettlInst()
        throws FieldNotFound {
    ...
    public static class NoSettlInst extends Group {
        ...
        public NoSettlInst() {
            super(778, 162,
                new int[] {
                    162, 163, 214, 453, 54, 460, 167, 461, 168, 126, 779, 172,
                    169, 170, 171, 85, 492, 476, 488, 489, 503, 490, 491, 504,
                    505, 0
                });
        }
        ...
        public quickfix.field.PaymentMethod get(
            quickfix.field.PaymentMethod value) throws FieldNotFound {
            getField(value);
        ...
        public quickfix.field.PaymentRef getPaymentRef()
            throws FieldNotFound {
        ...
        public quickfix.field.CardNumber getCardNumber()
            throws FieldNotFound {
        ...
        public quickfix.field.CardStartDate get(
            quickfix.field.CardStartDate value) throws FieldNotFound {
            getField(value);
        ...
        public quickfix.field.CardIssNum getCardIssNum()
            throws FieldNotFound {
