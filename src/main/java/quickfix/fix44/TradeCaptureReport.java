...
public class TradeCaptureReport extends Message {
    ...
    public TradeCaptureReport(quickfix.field.TradeReportID tradeReportID,
        quickfix.field.PreviouslyReported previouslyReported,
        quickfix.field.LastQty lastQty, quickfix.field.LastPx lastPx,
    ...
    public quickfix.fix44.component.PositionAmountData get(
        quickfix.fix44.component.PositionAmountData component)
        throws FieldNotFound {
        getComponent(component);
    ...
    public quickfix.fix44.component.PositionAmountData getPositionAmountData()
        throws FieldNotFound {
        quickfix.fix44.component.PositionAmountData component = new quickfix.fix44.component.PositionAmountData();
        getComponent(component);
    ...
    public quickfix.fix44.component.TrdRegTimestamps get(
        quickfix.fix44.component.TrdRegTimestamps component)
        throws FieldNotFound {
        getComponent(component);
    ...
    public quickfix.fix44.component.TrdRegTimestamps getTrdRegTimestamps()
        throws FieldNotFound {
        quickfix.fix44.component.TrdRegTimestamps component = new quickfix.fix44.component.TrdRegTimestamps();
        getComponent(component);
    ...
    public static class NoPosAmt extends Group {
        ...
        public NoPosAmt() {
            super(753, 707, new int[] { 707, 708, 0 });
        }
    ...
    public static class NoTrdRegTimestamps extends Group {
        ...
        public NoTrdRegTimestamps() {
            super(768, 769, new int[] { 769, 770, 771, 0 });
        }
    ...
    public static class NoSides extends Group {
        ...
        public quickfix.fix44.component.Parties get(
            quickfix.fix44.component.Parties component)
            throws FieldNotFound {
            getComponent(component);
        ...
        public quickfix.field.GrossTradeAmt get(
            quickfix.field.GrossTradeAmt value) throws FieldNotFound {
            getField(value);
        ...
        public static class NoAllocs extends Group {
            ...
            public NoAllocs() {
                super(78, 79, new int[] { 79, 661, 736, 467, 756, 80, 0 });
            }
            ...
            public quickfix.fix44.component.NestedParties2 get(
                quickfix.fix44.component.NestedParties2 component)
                throws FieldNotFound {
                getComponent(component);
            ...
            public quickfix.fix44.component.NestedParties2 getNestedParties2()
                throws FieldNotFound {
                quickfix.fix44.component.NestedParties2 component = new quickfix.fix44.component.NestedParties2();
                getComponent(component);
