...
public class RequestForPositionsAck extends Message {
    ...
    public RequestForPositionsAck(quickfix.field.PosMaintRptID posMaintRptID,
        quickfix.field.PosReqResult posReqResult,
        quickfix.field.PosReqStatus posReqStatus,
    ...
    public quickfix.field.PosReqStatus get(quickfix.field.PosReqStatus value)
        throws FieldNotFound {
        getField(value);
    ...
    public quickfix.field.PosReqStatus getPosReqStatus()
        throws FieldNotFound {
        quickfix.field.PosReqStatus value = new quickfix.field.PosReqStatus();
        getField(value);
