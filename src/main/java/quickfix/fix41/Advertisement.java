...
public class Advertisement extends Message {
    ...
    public Advertisement(quickfix.field.AdvId advId,
        quickfix.field.AdvTransType advTransType, quickfix.field.Symbol symbol,
        quickfix.field.AdvSide advSide, quickfix.field.Shares shares) {
        this();
        setField(advId);
    ...
    public quickfix.field.AdvTransType getAdvTransType()
        throws FieldNotFound {
