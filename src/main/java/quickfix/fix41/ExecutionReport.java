...
public class ExecutionReport extends Message {
    ...
    public ExecutionReport(quickfix.field.OrderID orderID,
        quickfix.field.ExecID execID,
        quickfix.field.ExecTransType execTransType,
        quickfix.field.ExecType execType, quickfix.field.OrdStatus ordStatus,
        quickfix.field.Symbol symbol, quickfix.field.Side side,
        quickfix.field.OrderQty orderQty, quickfix.field.LastShares lastShares,
        quickfix.field.LastPx lastPx, quickfix.field.LeavesQty leavesQty,
        quickfix.field.CumQty cumQty, quickfix.field.AvgPx avgPx) {
        this();
        setField(orderID);
        setField(execID);
    ...
    public quickfix.field.ExecTransType getExecTransType()
        throws FieldNotFound {
