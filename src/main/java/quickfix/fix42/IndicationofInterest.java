...
public class IndicationofInterest extends Message {
    ...
    public IndicationofInterest(quickfix.field.IOIid iOIid,
        quickfix.field.IOITransType iOITransType, quickfix.field.Symbol symbol,
        quickfix.field.Side side, quickfix.field.IOIShares iOIShares) {
        this();
        setField(iOIid);
    ...
    public quickfix.field.SpreadToBenchmark get(
        quickfix.field.SpreadToBenchmark value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.SpreadToBenchmark getSpreadToBenchmark()
        throws FieldNotFound {
