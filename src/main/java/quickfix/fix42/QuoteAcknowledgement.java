...
public class QuoteAcknowledgement extends Message {
    ...
    public quickfix.field.QuoteAckStatus get(
        quickfix.field.QuoteAckStatus value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.QuoteAckStatus getQuoteAckStatus()
        throws FieldNotFound {
        ...
        public NoQuoteSets() {
            super(296, 302,
                new int[] {
                    ...
                    435, 308, 306, 362, 363, 307, 364, 365, 304, 295, 0
                });
        }
            ...
            public NoQuoteEntries() {
                super(295, 299,
                    new int[] {
                        ...
                        223, 207, 106, 348, 349, 107, 350, 351, 368, 0
                    });
            }
