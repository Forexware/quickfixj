...
public class SecurityDefinitionRequest extends Message {
    ...
    public SecurityDefinitionRequest(
        ...
        quickfix.field.SecurityRequestType securityRequestType) {
        this();
    ...
    public quickfix.field.SecurityRequestType get(
        quickfix.field.SecurityRequestType value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.SecurityRequestType getSecurityRequestType()
        throws FieldNotFound {
        quickfix.field.SecurityRequestType value = new quickfix.field.SecurityRequestType();
        getField(value);
