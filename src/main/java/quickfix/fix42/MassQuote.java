...
public class MassQuote extends Message {
    ...
    public static class NoQuoteSets extends Group {
        ...
        public NoQuoteSets() {
            super(296, 302,
                new int[] {
                    302, 311, 312, 309, 305, 310, 313, 314, 315, 316, 317, 436,
                    435, 308, 306, 362, 363, 307, 364, 365, 367, 304, 295, 0
                });
        }
        ...
        public quickfix.field.UnderlyingIDSource get(
            quickfix.field.UnderlyingIDSource value) throws FieldNotFound {
            getField(value);

            return value;
        }

        public quickfix.field.UnderlyingIDSource getUnderlyingIDSource()
            throws FieldNotFound {
        ...
        public quickfix.field.UnderlyingMaturityDay get(
            quickfix.field.UnderlyingMaturityDay value)
            throws FieldNotFound {
            getField(value);
        ...
        public quickfix.field.UnderlyingMaturityDay getUnderlyingMaturityDay()
            throws FieldNotFound {
        ...
        public static class NoQuoteEntries extends Group {
            ...
            public NoQuoteEntries() {
                super(295, 299,
                    new int[] {
                        299, 55, 65, 48, 22, 167, 200, 205, 201, 202, 206, 231,
                        223, 207, 106, 348, 349, 107, 350, 351, 132, 133, 134,
                        135, 62, 188, 190, 189, 191, 60, 336, 64, 40, 193, 192,
                        15, 0
                    });
            }
            ...
            public quickfix.field.IDSource getIDSource()
                throws FieldNotFound {
            ...
            public quickfix.field.MaturityDay get(
                quickfix.field.MaturityDay value) throws FieldNotFound {
                getField(value);
