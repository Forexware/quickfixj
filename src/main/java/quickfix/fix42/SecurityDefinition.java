...
public class SecurityDefinition extends Message {
    ...
    public SecurityDefinition(quickfix.field.SecurityReqID securityReqID,
    ...
    public static class NoRelatedSym extends Group {
        ...
        public NoRelatedSym() {
            super(146, 311,
                new int[] {
                    311, 312, 309, 305, 310, 313, 314, 315, 316, 317, 436, 435,
                    308, 306, 362, 363, 307, 364, 365, 319, 54, 318, 0
                });
        }
        ...
        public quickfix.field.RatioQty get(quickfix.field.RatioQty value)
            throws FieldNotFound {
            getField(value);
        ...
        public quickfix.field.RatioQty getRatioQty() throws FieldNotFound {
            quickfix.field.RatioQty value = new quickfix.field.RatioQty();
            getField(value);
