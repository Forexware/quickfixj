...
public class RFQRequest extends Message {
    ...
    public quickfix.fix50.component.RFQReqGrp get(
        quickfix.fix50.component.RFQReqGrp component) throws FieldNotFound {
        getComponent(component);

        return component;
    }

    public quickfix.fix50.component.RFQReqGrp getRFQReqGrp()
        throws FieldNotFound {
        quickfix.fix50.component.RFQReqGrp component = new quickfix.fix50.component.RFQReqGrp();
        getComponent(component);
        ...
        public NoRelatedSym() {
            super(146, 55,
                new int[] {
                    ...
                    971, 1018, 996, 997, 1079, 711, 555, 140, 303, 537, 336, 625,
                    0
                });
        }
