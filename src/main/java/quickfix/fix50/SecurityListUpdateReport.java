...
public class SecurityListUpdateReport extends Message {
    ...
    public quickfix.field.SecurityUpdateAction get(
        quickfix.field.SecurityUpdateAction value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.SecurityUpdateAction getSecurityUpdateAction()
        throws FieldNotFound {
        quickfix.field.SecurityUpdateAction value = new quickfix.field.SecurityUpdateAction();
        getField(value);
    ...
    public quickfix.fix50.component.SecLstUpdRelSymGrp get(
        quickfix.fix50.component.SecLstUpdRelSymGrp component)
        throws FieldNotFound {
    ...
    public quickfix.fix50.component.SecLstUpdRelSymGrp getSecLstUpdRelSymGrp()
        throws FieldNotFound {
        quickfix.fix50.component.SecLstUpdRelSymGrp component = new quickfix.fix50.component.SecLstUpdRelSymGrp();
        getComponent(component);
    ...
    public static class NoRelatedSym extends Group {
        ...
        public NoRelatedSym() {
            super(146, 55,
                new int[] {
                    ...
                    788, 916, 917, 919, 898, 555, 218, 220, 221, 222, 662, 663,
                    699, 761, 235, 236, 701, 696, 697, 698, 561, 562, 336, 625,
                    827, 58, 354, 355, 311, 312, 309, 305, 457, 462, 463, 310,
                    763, 313, 542, 241, 242, 243, 244, 245, 246, 256, 595, 592,
                    593, 594, 247, 316, 941, 317, 436, 435, 308, 306, 362, 363,
                    307, 364, 365, 877, 878, 318, 879, 810, 882, 883, 884, 885,
                    886, 887, 972, 975, 973, 974, 998, 1000, 1038, 1058, 1039,
                    1044, 1045, 1046, 15, 232, 0
                });
        }
        ...
        public void set(
            quickfix.fix50.component.SecLstUpdRelSymsLegGrp component) {
            setComponent(component);
        }

        public quickfix.fix50.component.SecLstUpdRelSymsLegGrp get(
            quickfix.fix50.component.SecLstUpdRelSymsLegGrp component)
            throws FieldNotFound {
            getComponent(component);
        ...
        public quickfix.fix50.component.SecLstUpdRelSymsLegGrp getSecLstUpdRelSymsLegGrp()
            throws FieldNotFound {
            quickfix.fix50.component.SecLstUpdRelSymsLegGrp component = new quickfix.fix50.component.SecLstUpdRelSymsLegGrp();
            getComponent(component);
