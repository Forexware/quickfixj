...
public class AllocationReportAck extends Message {
    ...
    public AllocationReportAck(quickfix.field.AllocReportID allocReportID,
        quickfix.field.AllocID allocID) {
        this();
    ...
    public quickfix.fix50.component.AllocAckGrp get(
        quickfix.fix50.component.AllocAckGrp component)
        throws FieldNotFound {
        getComponent(component);
    ...
    public quickfix.fix50.component.AllocAckGrp getAllocAckGrp()
        throws FieldNotFound {
        quickfix.fix50.component.AllocAckGrp component = new quickfix.fix50.component.AllocAckGrp();
        getComponent(component);
