...
public class RegistrationInstructions extends Message {
    ...
    public RegistrationInstructions(quickfix.field.RegistID registID,
        quickfix.field.RegistTransType registTransType,
        quickfix.field.RegistRefID registRefID) {
        this();
        setField(registID);
    ...
    public quickfix.field.RegistTransType get(
        quickfix.field.RegistTransType value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.RegistTransType getRegistTransType()
        throws FieldNotFound {
    ...
    public quickfix.field.RegistRefID getRegistRefID()
        throws FieldNotFound {
    ...
    public quickfix.field.RegistAcctType get(
        quickfix.field.RegistAcctType value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.RegistAcctType getRegistAcctType()
        throws FieldNotFound {
    ...
    public quickfix.field.TaxAdvantageType get(
        quickfix.field.TaxAdvantageType value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.TaxAdvantageType getTaxAdvantageType()
        throws FieldNotFound {
    ...
    public quickfix.field.OwnershipType getOwnershipType()
        throws FieldNotFound {
    ...
    public quickfix.fix50.component.RgstDtlsGrp get(
        quickfix.fix50.component.RgstDtlsGrp component)
        throws FieldNotFound {
        getComponent(component);
    ...
    public quickfix.fix50.component.RgstDtlsGrp getRgstDtlsGrp()
        throws FieldNotFound {
        quickfix.fix50.component.RgstDtlsGrp component = new quickfix.fix50.component.RgstDtlsGrp();
        getComponent(component);
    ...
    public quickfix.fix50.component.RgstDistInstGrp get(
        quickfix.fix50.component.RgstDistInstGrp component)
        throws FieldNotFound {
        getComponent(component);
    ...
    public quickfix.fix50.component.RgstDistInstGrp getRgstDistInstGrp()
        throws FieldNotFound {
        quickfix.fix50.component.RgstDistInstGrp component = new quickfix.fix50.component.RgstDistInstGrp();
        getComponent(component);
