...
public class PositionReport extends Message {
    ...
    public quickfix.fix50.component.PosUndInstrmtGrp get(
        quickfix.fix50.component.PosUndInstrmtGrp component)
        throws FieldNotFound {
        getComponent(component);
    ...
    public quickfix.fix50.component.PosUndInstrmtGrp getPosUndInstrmtGrp()
        throws FieldNotFound {
        quickfix.fix50.component.PosUndInstrmtGrp component = new quickfix.fix50.component.PosUndInstrmtGrp();
        getComponent(component);
