...
public class TradeCaptureReportRequest extends Message {
    ...
    public TradeCaptureReportRequest(
        quickfix.field.TradeRequestID tradeRequestID,
        quickfix.field.TradeRequestType tradeRequestType) {
        this();
    ...
    public quickfix.field.TradeRequestType get(
        quickfix.field.TradeRequestType value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.TradeRequestType getTradeRequestType()
        throws FieldNotFound {
    ...
    public quickfix.fix50.component.TrdCapDtGrp get(
        quickfix.fix50.component.TrdCapDtGrp component)
        throws FieldNotFound {
        getComponent(component);
    ...
    public quickfix.fix50.component.TrdCapDtGrp getTrdCapDtGrp()
        throws FieldNotFound {
        quickfix.fix50.component.TrdCapDtGrp component = new quickfix.fix50.component.TrdCapDtGrp();
        getComponent(component);
