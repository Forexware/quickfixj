...
public class ExecutionAcknowledgement extends Message {
    ...
    public ExecutionAcknowledgement(quickfix.field.OrderID orderID,
        quickfix.field.ExecAckStatus execAckStatus,
        quickfix.field.ExecID execID, quickfix.field.Side side) {
        this();
        setField(orderID);
    ...
    public quickfix.field.ExecAckStatus get(quickfix.field.ExecAckStatus value)
        throws FieldNotFound {
        getField(value);
    ...
    public quickfix.field.ExecAckStatus getExecAckStatus()
        throws FieldNotFound {
        quickfix.field.ExecAckStatus value = new quickfix.field.ExecAckStatus();
        getField(value);
