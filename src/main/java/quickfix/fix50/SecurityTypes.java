...
public class SecurityTypes extends Message {
    ...
    public SecurityTypes(quickfix.field.SecurityReqID securityReqID,
        quickfix.field.SecurityResponseID securityResponseID,
        quickfix.field.SecurityResponseType securityResponseType) {
        this();
    ...
    public quickfix.field.TotNoSecurityTypes get(
        quickfix.field.TotNoSecurityTypes value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.TotNoSecurityTypes getTotNoSecurityTypes()
        throws FieldNotFound {
        quickfix.field.TotNoSecurityTypes value = new quickfix.field.TotNoSecurityTypes();
        getField(value);
    ...
    public quickfix.fix50.component.SecTypesGrp get(
        quickfix.fix50.component.SecTypesGrp component)
        throws FieldNotFound {
    ...
    public quickfix.fix50.component.SecTypesGrp getSecTypesGrp()
        throws FieldNotFound {
        quickfix.fix50.component.SecTypesGrp component = new quickfix.fix50.component.SecTypesGrp();
        getComponent(component);
    ...
    public quickfix.field.NoSecurityTypes get(
        quickfix.field.NoSecurityTypes value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.NoSecurityTypes getNoSecurityTypes()
        throws FieldNotFound {
    ...
    public static class NoSecurityTypes extends Group {
        ...
        public NoSecurityTypes() {
            super(558, 167, new int[] { 167, 762, 460, 461, 0 });
        }
