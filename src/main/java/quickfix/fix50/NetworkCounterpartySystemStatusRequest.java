...
public class NetworkCounterpartySystemStatusRequest extends Message {
    ...
    public NetworkCounterpartySystemStatusRequest(
        quickfix.field.NetworkRequestType networkRequestType,
        quickfix.field.NetworkRequestID networkRequestID) {
        this();
    ...
    public quickfix.field.NetworkRequestType get(
        quickfix.field.NetworkRequestType value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.NetworkRequestType getNetworkRequestType()
    ...
    public quickfix.fix50.component.CompIDReqGrp get(
        quickfix.fix50.component.CompIDReqGrp component)
        throws FieldNotFound {
    ...
    public quickfix.fix50.component.CompIDReqGrp getCompIDReqGrp()
        throws FieldNotFound {
        quickfix.fix50.component.CompIDReqGrp component = new quickfix.fix50.component.CompIDReqGrp();
        getComponent(component);
