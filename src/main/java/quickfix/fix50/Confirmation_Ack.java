...
public class Confirmation_Ack extends Message {
    ...
    public Confirmation_Ack(quickfix.field.ConfirmID confirmID,
        quickfix.field.TradeDate tradeDate,
        quickfix.field.TransactTime transactTime,
        quickfix.field.AffirmStatus affirmStatus) {
        this();
        setField(confirmID);
        setField(tradeDate);
    ...
    public quickfix.field.AffirmStatus getAffirmStatus()
        throws FieldNotFound {
    ...
    public quickfix.field.ConfirmRejReason get(
        quickfix.field.ConfirmRejReason value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.ConfirmRejReason getConfirmRejReason()
        throws FieldNotFound {
