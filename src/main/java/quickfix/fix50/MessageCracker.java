 ...
 */
  ...
  */
    ...
    throws UnsupportedMessageType, FieldNotFound, IncorrectTagValue
  {
    ...
    if( msgTypeValue.equals(UserRequest.MSGTYPE) )
      onMessage( (UserRequest)message, sessionID );
    else
    if( msgTypeValue.equals(UserResponse.MSGTYPE) )
    ...
    if( msgTypeValue.equals(QuoteResponse.MSGTYPE) )
      onMessage( (QuoteResponse)message, sessionID );
    else
    if( msgTypeValue.equals(QuoteRequestReject.MSGTYPE) )
      onMessage( (QuoteRequestReject)message, sessionID );
    else
    if( msgTypeValue.equals(RFQRequest.MSGTYPE) )
    ...
    if( msgTypeValue.equals(QuoteStatusReport.MSGTYPE) )
    ...
    if( msgTypeValue.equals(MassQuoteAcknowledgement.MSGTYPE) )
    ...
    if( msgTypeValue.equals(SecurityTypeRequest.MSGTYPE) )
      onMessage( (SecurityTypeRequest)message, sessionID );
    else
    if( msgTypeValue.equals(SecurityTypes.MSGTYPE) )
      onMessage( (SecurityTypes)message, sessionID );
    else
    if( msgTypeValue.equals(SecurityListRequest.MSGTYPE) )
      onMessage( (SecurityListRequest)message, sessionID );
    else
    if( msgTypeValue.equals(SecurityList.MSGTYPE) )
      onMessage( (SecurityList)message, sessionID );
    else
    if( msgTypeValue.equals(DerivativeSecurityListRequest.MSGTYPE) )
      onMessage( (DerivativeSecurityListRequest)message, sessionID );
    else
    if( msgTypeValue.equals(DerivativeSecurityList.MSGTYPE) )
    ...
    if( msgTypeValue.equals(DontKnowTradeDK.MSGTYPE) )
    ...
    if( msgTypeValue.equals(OrderMassCancelRequest.MSGTYPE) )
      onMessage( (OrderMassCancelRequest)message, sessionID );
    else
    if( msgTypeValue.equals(OrderMassCancelReport.MSGTYPE) )
      onMessage( (OrderMassCancelReport)message, sessionID );
    else
    if( msgTypeValue.equals(OrderMassStatusRequest.MSGTYPE) )
      onMessage( (OrderMassStatusRequest)message, sessionID );
    else
    if( msgTypeValue.equals(NewOrderCross.MSGTYPE) )
      onMessage( (NewOrderCross)message, sessionID );
    else
    if( msgTypeValue.equals(CrossOrderCancelReplaceRequest.MSGTYPE) )
      onMessage( (CrossOrderCancelReplaceRequest)message, sessionID );
    else
    if( msgTypeValue.equals(CrossOrderCancelRequest.MSGTYPE) )
      onMessage( (CrossOrderCancelRequest)message, sessionID );
    else
    if( msgTypeValue.equals(NewOrderMultileg.MSGTYPE) )
      onMessage( (NewOrderMultileg)message, sessionID );
    else
    if( msgTypeValue.equals(MultilegOrderCancelReplace.MSGTYPE) )
    ...
    if( msgTypeValue.equals(AllocationInstruction.MSGTYPE) )
      onMessage( (AllocationInstruction)message, sessionID );
    else
    if( msgTypeValue.equals(AllocationInstructionAck.MSGTYPE) )
      onMessage( (AllocationInstructionAck)message, sessionID );
    else
    if( msgTypeValue.equals(AllocationReport.MSGTYPE) )
      onMessage( (AllocationReport)message, sessionID );
    else
    if( msgTypeValue.equals(AllocationReportAck.MSGTYPE) )
      onMessage( (AllocationReportAck)message, sessionID );
    else
    if( msgTypeValue.equals(Confirmation.MSGTYPE) )
      onMessage( (Confirmation)message, sessionID );
    else
    if( msgTypeValue.equals(Confirmation_Ack.MSGTYPE) )
      onMessage( (Confirmation_Ack)message, sessionID );
    else
    if( msgTypeValue.equals(ConfirmationRequest.MSGTYPE) )
    ...
    if( msgTypeValue.equals(SettlementInstructionRequest.MSGTYPE) )
      onMessage( (SettlementInstructionRequest)message, sessionID );
    else
    if( msgTypeValue.equals(TradeCaptureReportRequest.MSGTYPE) )
      onMessage( (TradeCaptureReportRequest)message, sessionID );
    else
    if( msgTypeValue.equals(TradeCaptureReportRequestAck.MSGTYPE) )
      onMessage( (TradeCaptureReportRequestAck)message, sessionID );
    else
    if( msgTypeValue.equals(TradeCaptureReport.MSGTYPE) )
      onMessage( (TradeCaptureReport)message, sessionID );
    else
    if( msgTypeValue.equals(TradeCaptureReportAck.MSGTYPE) )
      onMessage( (TradeCaptureReportAck)message, sessionID );
    else
    if( msgTypeValue.equals(RegistrationInstructions.MSGTYPE) )
      onMessage( (RegistrationInstructions)message, sessionID );
    else
    if( msgTypeValue.equals(RegistrationInstructionsResponse.MSGTYPE) )
      onMessage( (RegistrationInstructionsResponse)message, sessionID );
    else
    if( msgTypeValue.equals(PositionMaintenanceRequest.MSGTYPE) )
      onMessage( (PositionMaintenanceRequest)message, sessionID );
    else
    if( msgTypeValue.equals(PositionMaintenanceReport.MSGTYPE) )
      onMessage( (PositionMaintenanceReport)message, sessionID );
    else
    if( msgTypeValue.equals(RequestForPositions.MSGTYPE) )
      onMessage( (RequestForPositions)message, sessionID );
    else
    if( msgTypeValue.equals(RequestForPositionsAck.MSGTYPE) )
      onMessage( (RequestForPositionsAck)message, sessionID );
    else
    if( msgTypeValue.equals(PositionReport.MSGTYPE) )
      onMessage( (PositionReport)message, sessionID );
    else
    if( msgTypeValue.equals(AssignmentReport.MSGTYPE) )
      onMessage( (AssignmentReport)message, sessionID );
    else
    if( msgTypeValue.equals(CollateralRequest.MSGTYPE) )
      onMessage( (CollateralRequest)message, sessionID );
    else
    if( msgTypeValue.equals(CollateralAssignment.MSGTYPE) )
      onMessage( (CollateralAssignment)message, sessionID );
    else
    if( msgTypeValue.equals(CollateralResponse.MSGTYPE) )
      onMessage( (CollateralResponse)message, sessionID );
    else
    if( msgTypeValue.equals(CollateralReport.MSGTYPE) )
      onMessage( (CollateralReport)message, sessionID );
    else
    if( msgTypeValue.equals(CollateralInquiry.MSGTYPE) )
      onMessage( (CollateralInquiry)message, sessionID );
    else
    if( msgTypeValue.equals(NetworkCounterpartySystemStatusRequest.MSGTYPE) )
      onMessage( (NetworkCounterpartySystemStatusRequest)message, sessionID );
    else
    if( msgTypeValue.equals(NetworkCounterpartySystemStatusResponse.MSGTYPE) )
      onMessage( (NetworkCounterpartySystemStatusResponse)message, sessionID );
    else
    if( msgTypeValue.equals(CollateralInquiryAck.MSGTYPE) )
      onMessage( (CollateralInquiryAck)message, sessionID );
    else
    if( msgTypeValue.equals(ContraryIntentionReport.MSGTYPE) )
      onMessage( (ContraryIntentionReport)message, sessionID );
    else
    if( msgTypeValue.equals(SecurityDefinitionUpdateReport.MSGTYPE) )
      onMessage( (SecurityDefinitionUpdateReport)message, sessionID );
    else
    if( msgTypeValue.equals(SecurityListUpdateReport.MSGTYPE) )
      onMessage( (SecurityListUpdateReport)message, sessionID );
    else
    if( msgTypeValue.equals(AdjustedPositionReport.MSGTYPE) )
      onMessage( (AdjustedPositionReport)message, sessionID );
    else
    if( msgTypeValue.equals(AllocationInstructionAlert.MSGTYPE) )
      onMessage( (AllocationInstructionAlert)message, sessionID );
    else
    if( msgTypeValue.equals(ExecutionAcknowledgement.MSGTYPE) )
      onMessage( (ExecutionAcknowledgement)message, sessionID );
    else
    if( msgTypeValue.equals(TradingSessionList.MSGTYPE) )
      onMessage( (TradingSessionList)message, sessionID );
    else
    if( msgTypeValue.equals(TradingSessionListRequest.MSGTYPE) )
      onMessage( (TradingSessionListRequest)message, sessionID );
    else
    if( msgTypeValue.equals(IOI.MSGTYPE) )
