...
public class QuoteRequest extends Message {
    ...
    public quickfix.fix50.component.QuotReqGrp get(
        quickfix.fix50.component.QuotReqGrp component)
        throws FieldNotFound {
    ...
    public quickfix.fix50.component.QuotReqGrp getQuotReqGrp()
        throws FieldNotFound {
        quickfix.fix50.component.QuotReqGrp component = new quickfix.fix50.component.QuotReqGrp();
        getComponent(component);
        ...
        public NoRelatedSym() {
            super(146, 55,
                new int[] {
                    ...
                    555, 735, 692, 40, 62, 126, 60, 218, 220, 221, 222, 662, 663,
