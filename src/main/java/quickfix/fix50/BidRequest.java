...
public class BidRequest extends Message {
    ...
    public BidRequest(quickfix.field.ClientBidID clientBidID,
        quickfix.field.BidRequestTransType bidRequestTransType,
        quickfix.field.TotNoRelatedSym totNoRelatedSym,
        quickfix.field.BidType bidType,
        quickfix.field.BidTradeType bidTradeType,
        quickfix.field.BasisPxType basisPxType) {
        this();
    ...
    public quickfix.field.BidRequestTransType get(
        quickfix.field.BidRequestTransType value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.BidRequestTransType getBidRequestTransType()
        throws FieldNotFound {
    ...
    public quickfix.fix50.component.BidDescReqGrp get(
        quickfix.fix50.component.BidDescReqGrp component)
        throws FieldNotFound {
    ...
    public quickfix.fix50.component.BidDescReqGrp getBidDescReqGrp()
        throws FieldNotFound {
        quickfix.fix50.component.BidDescReqGrp component = new quickfix.fix50.component.BidDescReqGrp();
        getComponent(component);
    ...
    public quickfix.fix50.component.BidCompReqGrp get(
        quickfix.fix50.component.BidCompReqGrp component)
        throws FieldNotFound {
        getComponent(component);
    ...
    public quickfix.fix50.component.BidCompReqGrp getBidCompReqGrp()
        throws FieldNotFound {
        quickfix.fix50.component.BidCompReqGrp component = new quickfix.fix50.component.BidCompReqGrp();
        getComponent(component);
    ...
    public quickfix.field.NoBidComponents get(
        quickfix.field.NoBidComponents value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.NoBidComponents getNoBidComponents()
        throws FieldNotFound {
    ...
    public quickfix.field.LiquidityIndType get(
        quickfix.field.LiquidityIndType value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.LiquidityIndType getLiquidityIndType()
        throws FieldNotFound {
    ...
    public quickfix.field.WtAverageLiquidity get(
        quickfix.field.WtAverageLiquidity value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.WtAverageLiquidity getWtAverageLiquidity()
        throws FieldNotFound {
    ...
    public quickfix.field.ExchangeForPhysical get(
        quickfix.field.ExchangeForPhysical value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.ExchangeForPhysical getExchangeForPhysical()
        throws FieldNotFound {
    ...
    public quickfix.field.OutMainCntryUIndex get(
        quickfix.field.OutMainCntryUIndex value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.OutMainCntryUIndex getOutMainCntryUIndex()
        throws FieldNotFound {
    ...
    public quickfix.field.CrossPercent getCrossPercent()
        throws FieldNotFound {
    ...
    public quickfix.field.BidTradeType get(quickfix.field.BidTradeType value)
        throws FieldNotFound {
        getField(value);
    ...
    public quickfix.field.BidTradeType getBidTradeType()
        throws FieldNotFound {
        quickfix.field.BidTradeType value = new quickfix.field.BidTradeType();
        getField(value);
    ...
    public quickfix.field.BasisPxType getBasisPxType()
        throws FieldNotFound {
    ...
    public static class NoBidComponents extends Group {
        ...
        public quickfix.field.NetGrossInd getNetGrossInd()
            throws FieldNotFound {
