...
public class SecurityStatus extends Message {
    ...
    public quickfix.field.SecurityTradingStatus get(
        quickfix.field.SecurityTradingStatus value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.SecurityTradingStatus getSecurityTradingStatus()
        throws FieldNotFound {
    ...
    public quickfix.field.InViewOfCommon get(
        quickfix.field.InViewOfCommon value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.InViewOfCommon getInViewOfCommon()
        throws FieldNotFound {
    ...
    public quickfix.field.DueToRelated getDueToRelated()
        throws FieldNotFound {
