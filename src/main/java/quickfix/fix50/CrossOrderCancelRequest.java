...
public class CrossOrderCancelRequest extends Message {
    ...
    public CrossOrderCancelRequest(quickfix.field.CrossID crossID,
    ...
    public quickfix.fix50.component.SideCrossOrdCxlGrp get(
        quickfix.fix50.component.SideCrossOrdCxlGrp component)
        throws FieldNotFound {
    ...
    public quickfix.fix50.component.SideCrossOrdCxlGrp getSideCrossOrdCxlGrp()
        throws FieldNotFound {
        quickfix.fix50.component.SideCrossOrdCxlGrp component = new quickfix.fix50.component.SideCrossOrdCxlGrp();
        getComponent(component);
    ...
    public static class NoSides extends Group {
        ...
        public NoSides() {
            super(552, 54,
                new int[] {
                    54, 41, 11, 526, 583, 586, 453, 229, 75, 38, 152, 516, 468,
                    469, 376, 58, 354, 355, 0
                });
        }
