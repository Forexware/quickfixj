...
public class QuoteCancel extends Message {
    ...
    public quickfix.fix50.component.QuotCxlEntriesGrp get(
        quickfix.fix50.component.QuotCxlEntriesGrp component)
        throws FieldNotFound {
        getComponent(component);
    ...
    public quickfix.fix50.component.QuotCxlEntriesGrp getQuotCxlEntriesGrp()
        throws FieldNotFound {
        quickfix.fix50.component.QuotCxlEntriesGrp component = new quickfix.fix50.component.QuotCxlEntriesGrp();
        getComponent(component);
