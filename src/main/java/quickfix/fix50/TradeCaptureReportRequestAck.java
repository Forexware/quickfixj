...
public class TradeCaptureReportRequestAck extends Message {
    ...
    public TradeCaptureReportRequestAck(
        ...
        quickfix.field.TradeRequestResult tradeRequestResult,
        quickfix.field.TradeRequestStatus tradeRequestStatus) {
        this();
    ...
    public quickfix.field.TradeRequestResult get(
        quickfix.field.TradeRequestResult value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.TradeRequestResult getTradeRequestResult()
        throws FieldNotFound {
        quickfix.field.TradeRequestResult value = new quickfix.field.TradeRequestResult();
        getField(value);
    ...
    public quickfix.field.TradeRequestStatus get(
        quickfix.field.TradeRequestStatus value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.TradeRequestStatus getTradeRequestStatus()
        throws FieldNotFound {
        quickfix.field.TradeRequestStatus value = new quickfix.field.TradeRequestStatus();
        getField(value);
