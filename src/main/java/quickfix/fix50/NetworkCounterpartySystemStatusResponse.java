...
public class NetworkCounterpartySystemStatusResponse extends Message {
    ...
    public NetworkCounterpartySystemStatusResponse(
        quickfix.field.NetworkStatusResponseType networkStatusResponseType,
        quickfix.field.NetworkResponseID networkResponseID) {
        this();
    ...
    public quickfix.field.NetworkStatusResponseType get(
        quickfix.field.NetworkStatusResponseType value)
    ...
    public quickfix.field.NetworkStatusResponseType getNetworkStatusResponseType()
        throws FieldNotFound {
    ...
    public quickfix.field.NetworkRequestID get(
        quickfix.field.NetworkRequestID value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.NetworkRequestID getNetworkRequestID()
        throws FieldNotFound {
    ...
    public quickfix.field.NetworkResponseID get(
        quickfix.field.NetworkResponseID value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.NetworkResponseID getNetworkResponseID()
        throws FieldNotFound {
    ...
    public quickfix.field.LastNetworkResponseID get(
        quickfix.field.LastNetworkResponseID value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.LastNetworkResponseID getLastNetworkResponseID()
        throws FieldNotFound {
    ...
    public quickfix.fix50.component.CompIDStatGrp get(
        quickfix.fix50.component.CompIDStatGrp component)
        throws FieldNotFound {
    ...
    public quickfix.fix50.component.CompIDStatGrp getCompIDStatGrp()
        throws FieldNotFound {
        quickfix.fix50.component.CompIDStatGrp component = new quickfix.fix50.component.CompIDStatGrp();
        getComponent(component);
