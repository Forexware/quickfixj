...
public class QuoteResponse extends Message {
    ...
    public QuoteResponse(quickfix.field.QuoteRespID quoteRespID,
        quickfix.field.QuoteRespType quoteRespType) {
        this();
    ...
    public quickfix.field.QuoteRespType get(quickfix.field.QuoteRespType value)
        throws FieldNotFound {
        getField(value);
    ...
    public quickfix.field.QuoteRespType getQuoteRespType()
        throws FieldNotFound {
        quickfix.field.QuoteRespType value = new quickfix.field.QuoteRespType();
        getField(value);
