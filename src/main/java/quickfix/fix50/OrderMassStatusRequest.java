...
public class OrderMassStatusRequest extends Message {
    ...
    public OrderMassStatusRequest(
        quickfix.field.MassStatusReqID massStatusReqID,
        quickfix.field.MassStatusReqType massStatusReqType) {
        this();
    ...
    public quickfix.field.MassStatusReqType get(
        quickfix.field.MassStatusReqType value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.MassStatusReqType getMassStatusReqType()
        throws FieldNotFound {
        quickfix.field.MassStatusReqType value = new quickfix.field.MassStatusReqType();
        getField(value);
