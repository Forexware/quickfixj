...
public class CrossOrderCancelReplaceRequest extends Message {
    ...
    public quickfix.fix50.component.SideCrossOrdModGrp get(
        quickfix.fix50.component.SideCrossOrdModGrp component)
        throws FieldNotFound {
    ...
    public quickfix.fix50.component.SideCrossOrdModGrp getSideCrossOrdModGrp()
        throws FieldNotFound {
        quickfix.fix50.component.SideCrossOrdModGrp component = new quickfix.fix50.component.SideCrossOrdModGrp();
        getComponent(component);
    ...
    public static class NoSides extends Group {
        ...
        public NoSides() {
            super(552, 54,
                new int[] {
                    54, 11, 526, 583, 453, 229, 75, 1, 660, 581, 589, 590, 591,
                    70, 78, 854, 38, 152, 516, 468, 469, 12, 13, 479, 497, 528,
                    529, 582, 121, 120, 775, 58, 354, 355, 77, 203, 544, 635,
                    377, 659, 962, 1091, 0
                });
        }
        ...
        public quickfix.field.SideTimeInForce get(
            quickfix.field.SideTimeInForce value) throws FieldNotFound {
            getField(value);

            return value;
        }

        public quickfix.field.SideTimeInForce getSideTimeInForce()
            throws FieldNotFound {
