...
public class DerivativeSecurityList extends Message {
    ...
    public DerivativeSecurityList(quickfix.field.SecurityReqID securityReqID,
    ...
    public quickfix.fix50.component.RelSymDerivSecGrp get(
        quickfix.fix50.component.RelSymDerivSecGrp component)
        throws FieldNotFound {
        getComponent(component);
    ...
    public quickfix.fix50.component.RelSymDerivSecGrp getRelSymDerivSecGrp()
        throws FieldNotFound {
        quickfix.fix50.component.RelSymDerivSecGrp component = new quickfix.fix50.component.RelSymDerivSecGrp();
        getComponent(component);
