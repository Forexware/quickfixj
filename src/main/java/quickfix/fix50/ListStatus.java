...
public class ListStatus extends Message {
    ...
    public ListStatus(quickfix.field.ListID listID,
        quickfix.field.ListStatusType listStatusType,
        quickfix.field.NoRpts noRpts,
        quickfix.field.ListOrderStatus listOrderStatus,
        quickfix.field.RptSeq rptSeq, quickfix.field.TotNoOrders totNoOrders) {
        this();
        setField(listID);
    ...
    public quickfix.field.ListStatusType get(
        quickfix.field.ListStatusType value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.ListStatusType getListStatusType()
        throws FieldNotFound {
    ...
    public quickfix.field.ListOrderStatus get(
        quickfix.field.ListOrderStatus value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.ListOrderStatus getListOrderStatus()
        throws FieldNotFound {
    ...
    public quickfix.field.ListStatusText get(
        quickfix.field.ListStatusText value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.ListStatusText getListStatusText()
        throws FieldNotFound {
    ...
    public quickfix.field.EncodedListStatusTextLen get(
        quickfix.field.EncodedListStatusTextLen value)
        throws FieldNotFound {
        getField(value);
    ...
    public quickfix.field.EncodedListStatusTextLen getEncodedListStatusTextLen()
        throws FieldNotFound {
    ...
    public quickfix.field.EncodedListStatusText get(
        quickfix.field.EncodedListStatusText value) throws FieldNotFound {
        getField(value);

        return value;
    }

    public quickfix.field.EncodedListStatusText getEncodedListStatusText()
        throws FieldNotFound {
    ...
    public quickfix.fix50.component.OrdListStatGrp get(
        quickfix.fix50.component.OrdListStatGrp component)
        throws FieldNotFound {
    ...
    public quickfix.fix50.component.OrdListStatGrp getOrdListStatGrp()
        throws FieldNotFound {
        quickfix.fix50.component.OrdListStatGrp component = new quickfix.fix50.component.OrdListStatGrp();
        getComponent(component);
