...
public class BidResponse extends Message {
    ...
    public quickfix.fix50.component.BidCompRspGrp get(
        quickfix.fix50.component.BidCompRspGrp component)
        throws FieldNotFound {
    ...
    public quickfix.fix50.component.BidCompRspGrp getBidCompRspGrp()
        throws FieldNotFound {
        quickfix.fix50.component.BidCompRspGrp component = new quickfix.fix50.component.BidCompRspGrp();
        getComponent(component);
