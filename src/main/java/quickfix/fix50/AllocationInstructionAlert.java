...
public class AllocationInstructionAlert extends Message {
    ...
    public AllocationInstructionAlert(quickfix.field.AllocID allocID,
        quickfix.field.AllocTransType allocTransType,
        quickfix.field.AllocType allocType, quickfix.field.Side side,
        quickfix.field.Quantity quantity, quickfix.field.TradeDate tradeDate) {
        this();
        setField(allocID);
