...
public class SettlementInstructions extends Message {
    ...
    public quickfix.fix50.component.SettlInstGrp get(
        quickfix.fix50.component.SettlInstGrp component)
        throws FieldNotFound {
    ...
    public quickfix.fix50.component.SettlInstGrp getSettlInstGrp()
        throws FieldNotFound {
        quickfix.fix50.component.SettlInstGrp component = new quickfix.fix50.component.SettlInstGrp();
        getComponent(component);
